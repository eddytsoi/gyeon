...
- **Run in the project directory.** All commands must be executed in the primary working directory of this project (`~/claude/projects/gyeon`), regardless of where the shell currently is.
