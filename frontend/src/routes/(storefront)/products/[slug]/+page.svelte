      ...
      <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
        {#each data.related as p}
          <a href="/products/{p.slug}"
            ...
            <div class="aspect-square bg-gray-50 overflow-hidden flex items-center justify-center text-gray-200 group-hover:scale-[1.02] transition-transform duration-500">
