<script lang="ts">
  // Official Stripe wordmark (Blurple #533AFD). Brand asset — keep the colour
  // and proportions exactly as supplied; never recolour or distort. Used inline
  // in place of the word "Stripe" in SecurePaymentNote; aria-label keeps it
  // readable to screen readers as plain text.
