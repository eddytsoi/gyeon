    ...
    <div class="flex items-center justify-between h-16 lg:h-20">
      ...
      <div class="flex items-center gap-0 sm:gap-1">
        ...
        <button
          ...
          data-search-toggle
          onclick={openSearch}
          class="p-2 lg:px-1 xl:p-2 text-ink-900 hover:text-navy-500 transition-colors"
        ...
        {#if customer}
          <div class="relative hidden lg:block" data-account-menu>
            <button
              ...
              class="p-2 lg:px-1 xl:p-2 text-ink-900 hover:text-navy-500 transition-colors flex items-center"
            ...
            {#if accountOpen}
              <div class="absolute right-0 mt-2 w-56 bg-white border border-ink-300/60 rounded-md shadow-card-hover py-1 origin-top-right">
                ...
                <a href="/account/purchased" onclick={() => accountOpen = false}
                   class="flex items-center gap-2 px-4 py-2 text-sm font-body text-ink-900 hover:bg-paper hover:text-navy-500 transition-colors">
                  <svg class="w-4 h-4 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.5">
                    <path stroke-linecap="round" stroke-linejoin="round" d="M16.023 9.348h4.992v-.001M2.985 19.644v-4.992m0 0h4.992m-4.993 0 3.181 3.183a8.25 8.25 0 0 0 13.803-3.7M4.031 9.865a8.25 8.25 0 0 1 13.803-3.7l3.181 3.182m0-4.991v4.99" />
                  </svg>
                  {m.account_nav_purchased()}
                </a>
                <a href="/account/wishlist" onclick={() => accountOpen = false}
                   class="flex items-center gap-2 px-4 py-2 text-sm font-body text-ink-900 hover:bg-paper hover:text-navy-500 transition-colors">
                  <svg class="w-4 h-4 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.5">
                    <path stroke-linecap="round" stroke-linejoin="round" d="M21 8.25c0-2.485-2.099-4.5-4.688-4.5-1.935 0-3.597 1.126-4.312 2.733-.715-1.607-2.377-2.733-4.313-2.733C5.1 3.75 3 5.765 3 8.25c0 7.22 9 12 9 12s9-4.78 9-12Z" />
                  </svg>
                  {m.header_menu_wishlist()}
                </a>
        ...
        {:else}
          <a
            href="/account/login"
            class="hidden lg:inline-flex p-2 lg:px-1 xl:p-2 text-ink-900 hover:text-navy-500 transition-colors"
        ...
        <a href="/wishlist" class="relative hidden lg:inline-flex p-2 lg:px-1 xl:p-2 text-gray-600 hover:text-gray-900 transition-colors" aria-label={m.wishlist_heading()}>
          <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none"
               viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.5">
            <path stroke-linecap="round" stroke-linejoin="round"
        ...
        <!-- Cart -->
        <a href="/cart" class="relative p-2 lg:px-1 xl:p-2 text-gray-600 hover:text-gray-900 transition-colors" aria-label={m.header_aria_cart()}>
          <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none"
               viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.5">
            <path stroke-linecap="round" stroke-linejoin="round"
